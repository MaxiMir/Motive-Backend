...
### ARTIFACTORY:
```shell
docker build -t maximir/backend:1.0.53 .

docker tag <IMAGE_ID> maximir.jfrog.io/default-docker-virtual/backend:1.0.53
docker push maximir.jfrog.io/default-docker-virtual/backend:1.0.53
docker pull maximir.jfrog.io/default-docker-virtual/backend:1.0.53
```
